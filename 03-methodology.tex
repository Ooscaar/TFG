...
\subsubsection{Configuration files}
The files that must be syncronized are:
\begin{itemize}
	\item{SSH: corresponding to \textbf{/etc/lxce/ssh/} folder}
	\item{VNC: corresponding to \textbf{/etc/lxce/remmina/} folder}
\end{itemize}
...
For the SSH configuration files we will save the files in the following structure:
\begin{minted}[bgcolor=background]{text}
\end{minted}
